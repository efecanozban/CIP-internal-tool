import { getTakenTodos, getGivenTodos, getWatchingTodos, getPersonnels, getPriorities, getProjects, getUserFromSession } from "$lib/server/db.js";
...
export async function load({ cookies }) {
    return {
        ...
        watchingTodos: await getGivenTodos(cookies.get('sessionid')),
